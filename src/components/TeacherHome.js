        ...
        <Carousel>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p>Provide instant feedback on assignments with our AI algorithms.</p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
        <h2>Empowering Teachers with AI</h2>
        <p>
          Harness the power of artificial intelligence to personalize learning experiences,
          automate grading, and gain insights into student performance.
        </p>
